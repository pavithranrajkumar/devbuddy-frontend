      ...
      <div className='hidden lg:flex lg:w-2/3 relative items-center justify-center bg-slate-900'>
        ...
        <div className='relative z-10 px-16'>
          ...
          <p className='text-xl text-slate-300 max-w-xl leading-relaxed'>
            Connect with top developers and bring your projects to life. Join our community of professionals today.
          </p>
        </div>
      </div>
      ...
      <div className='w-full lg:w-1/3 flex items-center justify-center p-8 bg-white dark:bg-slate-900'>
        <div className='w-full'>
          <div className='lg:hidden text-center mb-8'>
            ...
            <p className='text-slate-600 dark:text-slate-400'>Connect with top developers</p>
          </div>

          <Card className='shadow-none border-0 bg-white/50 dark:bg-slate-900'>
            <CardHeader className='space-y-1 pb-8'>
              <CardTitle className='text-2xl font-bold text-center'>Welcome back</CardTitle>
              <CardDescription className='text-center text-base'>Enter your credentials to sign in</CardDescription>
            </CardHeader>
            <CardContent className='space-y-6'>
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
                  <div className='space-y-4'>
                    <FormFieldComponent form={form} name='email' label='Email' placeholder='name@example.com' type='email' />

                    <FormFieldComponent form={form} name='password' label='Password' placeholder='••••••••' type='password' />
                  </div>
