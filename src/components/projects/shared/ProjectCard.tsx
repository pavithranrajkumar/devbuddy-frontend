    ...
    >
      ...
      <div className="relative">
        <div className="flex justify-between items-start gap-4">
          ...
          <Badge
            variant="secondary"
            className="capitalize text-xs px-2.5 py-1 bg-secondary/10 text-secondary-foreground/70 shrink-0 shadow-sm"
          >
        ...
        <div className="mt-3.5 flex flex-wrap gap-1.5">
          ...
          {project.skills?.length > 4 && (
            <Badge
              variant="outline"
              className="px-2.5 py-0.5 text-xs font-medium hover:bg-primary/5"
            >
